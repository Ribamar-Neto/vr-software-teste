#!/usr/bin/env python3
"""
Script de teste para verificar o funcionamento do consumidor RabbitMQ
"""
...
async def test_consumer() -> None:
    """Testa o consumidor enviando uma mensagem de teste"""
    ...
    test_message = {
        ...
        'message_content': 'Teste de mensagem do consumidor',
    ...
    await channel.default_exchange.publish(
        aio_pika.Message(
            body=json.dumps(test_message).encode(), delivery_mode=aio_pika.DeliveryMode.PERSISTENT
        ),
